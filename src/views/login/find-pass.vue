<template>
  <div id="g-login" class="g-login">
    ...
    <div class="g-login-top">
      <i class="iconfont icon-guanbi" @click="goBack"></i><span>找回密码</span>
    </div>
    <!--修改密码-->
    <div class="g-form">
      <el-form :model="ruleForm" :rules="rules" ref="ruleForm">
        <el-form-item prop="name">
          <div class="pass_back">
            <input type="text" v-model="ruleForm.name" placeholder="请输入账户名">
          </div>
        </el-form-item>
        ...
        <el-form-item prop="new_pass">
          <div class="pass_back">
            <input type="password" v-model="ruleForm.new_pass" placeholder="请输入新密码">
          </div>
        </el-form-item>
        <el-form-item prop="qr_pass">
          <div class="pass_back">
            <input type="password" v-model="ruleForm.qr_pass" placeholder="请确认新密码">
          </div>
        </el-form-item>
        <el-form-item>
    ...
    <div class="reg-type" v-if="popup">
      ...
      <p class="t-center"><b class="c-red">只能用已绑定的方式验证</b></p>
  ...
  export default {
    data() {
      ...
      return {
        ...
        rules: {
          name: [{validator: this.va.vaAct, trigger: 'blur'}],
    ...
    methods: {
      ...
      submitForm(formName) {
        this.$refs[formName].validate((valid) => {
          if (valid) {
            this.isLoading = true;
            this.axios.post(this.getApi('web/find_pass'),
              this.dafa({
                username: this.ruleForm.name,
                find_type: this.v_type,
                code: this.ruleForm.code,
                pass_type: this.c_type,
                newpass: this.ruleForm.new_pass
              })
            ).then(res => {
              this.isLoading = false;
              this.$message(res.data.msg);
